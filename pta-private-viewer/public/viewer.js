...
/**
 * 簡易的な保存抑止として、右クリックや画像ドラッグを止めます。
 * 画面キャプチャまでは防げませんが、一般的な保存操作はしにくくなります。
 * @param {Event} event
 */
...
pageImage.addEventListener("contextmenu", preventDefaultAction);
pageImage.addEventListener("dragstart", preventDefaultAction);
swipeSurface.addEventListener("contextmenu", preventDefaultAction);
