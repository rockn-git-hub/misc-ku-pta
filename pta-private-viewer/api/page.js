...
const { handleBlobStoreUnavailable, sendBinary, sendJson } = httpUtilsModule.default || httpUtilsModule;
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    sendBinary(
      ...
      200,
      file.buffer,
      file.contentType || page.contentType || "image/webp",
      responseHeaders
    );
  } catch (error) {
